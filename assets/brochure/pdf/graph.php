...
if($data == 1){
	$datay = array(10000,7000,15000,24000);
	$datax = array(1566342307, 1563231907, 1560812707, 1558739107);
}
else{
	$datay = array(20000,10000,7000,10000);
	$datax = array(1566342307, 1563231907, 1560812707, 1558739107);
}
